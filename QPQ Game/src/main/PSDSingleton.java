...
public class PSDSingleton {
	...
	public void saveFormCData() {
		...
		try {
			...
			for (int i = 0; i < arr.size(); i++) {
				pw.write("" + arr.get(i)[0] + "," + arr.get(i)[1] + "," + arr.get(i)[2] + "," + arr.get(i)[3] + ","
						+ arr.get(i)[4] + "\n");
			}
			pw.close();
	...
	public void saveFormDData() {
		...
		try {
			...
			for (int i = 0; i < arr.size(); i++) {
				pw.write("" + arr.get(i)[0] + "," + arr.get(i)[1] + "," + arr.get(i)[2] + "," + arr.get(i)[3] + ","
						+ arr.get(i)[4] + "," + arr.get(i)[5] + "," + arr.get(i)[6] + "," + arr.get(i)[7] + ","
	...
	public void exportData() {
		...
		try {
			...
			for (int i = 0; i < formBData.size(); i++) {
				pw.write("" + formBData.get(i)[0] + "," + formBData.get(i)[1] + "," + formBData.get(i)[2] + ","
						+ formBData.get(i)[3] + "," + formBData.get(i)[4] + "," + formBData.get(i)[5] + ","
		...
		try {
			...
			for (int i = 0; i < formTData.size(); i++) {
				pw.write("" + formTData.get(i).getName() + "," + formTData.get(i).getDepartmentWithoutBreak() + ","
						+ formTData.get(i).getMultiSkilled() + "," + formTData.get(i).getTime1() + ","
						+ formTData.get(i).getTime2() + "," + formTData.get(i).getTotTime() + ","
						+ formTData.get(i).getWage() + "," + formTData.get(i).getRoundCount() + "\n");
			}
			pw.close();
		} catch (FileNotFoundException e) {
			e.printStackTrace();
		...
		try {
			...
			for (int i = 0; i < formVData.size(); i++) {
				pw.write("" + formVData.get(i).getRoundNum() + "," + formVData.get(i).getTotalRevenue() + ","
						+ formVData.get(i).getEmployeeWage() + "," + formVData.get(i).getAynPay() + ","
						+ formVData.get(i).getMaterialsSum() + "," + formVData.get(i).getTotalExpenditure() + ","
						+ formVData.get(i).getProfitLoss() + "\n");
			}
			pw.close();
		} catch (FileNotFoundException e) {
			e.printStackTrace();
	...
	public void reportData() {
		...
		try {
			...
			pw.write("Worker name" + "," + "Department" + "," + "Is multiskilled" + "," + "Time 1" + "," + "Time 2"
					+ "," + "Total time" + "," + "Wage" + "," + "Round" + "\n");
			...
			pw.write("Round" + "," + "Total revenue" + "," + "Employees wage" + "," + "AYN" + "," + "Materials sum"
	...
	public void importData() {
		...
		for (int i = 0; i < formVData.size(); i++) {
			try {
				rounds.add(new Round(formVData.get(i)[0], formVData.get(i)[1], formVData.get(i)[2], formVData.get(i)[3],
						formVData.get(i)[4], formVData.get(i)[5], formVData.get(i)[6]));
			} catch (Exception e) {
			}
		}
