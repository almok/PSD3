...
public class Main_temp extends Application implements EventHandler<ActionEvent>{
	...
	static Scene formTScene;
		...
		public void start(Stage arg0) throws Exception {
			//Parent layout = FXMLLoader.load(getClass().getResource("formB.fxml"));
			arg0.setTitle("Project PSD");
			Main_temp.window = arg0;
...
//			layout.getChildren().add(b);
			...
			layout.getChildren().add(new Text("          Salary"));
