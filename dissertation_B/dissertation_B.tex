...
\input{figures/startGame}
\subsubsection{Settings}
\input{figures/settings}
\input{figures/settings-change}
...
Enter data correctly for each field. An example is given in Figure 11. Scheduled Delivery Time, Chassis Type, Penalty and Revenue are automatically generated. \input{figures/FormB}
